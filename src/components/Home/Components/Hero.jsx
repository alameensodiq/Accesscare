...
const Hero = () => {
    return (
        <div className="relative mb-16 h-[500px] lg:h-[840px]">
            {/* Background Image */}
            <div
                className="absolute inset-0 bg-cover bg-center filter grayscale"
                style={{
                    backgroundImage: `url(${hero})`, // Correctly setting the image URL
                }}
            ></div>
            {/* Black Overlay */}
            ...
            <div className="relative flex flex-col container mx-auto px-6 lg:px-20 py-20 lg:py-40 items-center text-center text-white">
                <h1 className="text-4xl md:text-6xl lg:text-8xl font-semibold leading-tight mb-6 relative inline-block">
                ...
                <div className="flex justify-center gap-6">
                    {/* Get Started Button */}
                    <a href="/get-started">
                        <button className="bg-[#1bb96a] text-black px-8 py-3 rounded-full font-medium hover:bg-[#45E99E] hover:text-white transition duration-300">
                            Get Started
                        </button>
                    </a>
                    {/* Get Involved Button */}
                    <a href="/get-involved">
                        <button className="bg-transparent text-[#1bb96a] border border-[#1bb96a] px-8 py-3 rounded-full font-medium hover:bg-[#1bb96a] hover:text-white transition duration-300">
                            Get Involved
                        </button>
                    </a>
                </div>
